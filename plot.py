...
#This function display the menu of visualisation selection.
def plot_menu():
...
#This function display the proportion of number of bedrooms of Airbnb listing using pie chart. 
...
#This function display the relationship between accommodates and price using scatter plot.
